...
const envSchema = z
  .object({
    ...
    DATABASE_URL: z
      .string()
      .min(1)
      .default('mysql://mem9:mem9@127.0.0.1:3306/mem9'),
    ...
    S3_BUCKET_ANALYSIS_PAYLOADS: z
      .string()
      .min(1)
      .default('mem9-analysis-payloads'),
    SQS_ANALYSIS_BATCH_QUEUE_URL: z
      .string()
      .min(1)
      .default('http://127.0.0.1:4566/000000000000/analysis-batch'),
    SQS_ANALYSIS_BATCH_DLQ_URL: z
      .string()
      .min(1)
      .default('http://127.0.0.1:4566/000000000000/analysis-batch-dlq'),
    SQS_ANALYSIS_LLM_QUEUE_URL: z
      .string()
      .min(1)
      .default('http://127.0.0.1:4566/000000000000/analysis-llm'),
    SQS_ANALYSIS_LLM_DLQ_URL: z
      .string()
      .min(1)
      .default('http://127.0.0.1:4566/000000000000/analysis-llm-dlq'),
    MEM9_SOURCE_API_BASE_URL: z
      .string()
      .url()
      .default('http://127.0.0.1:8080/v1alpha2/mem9s'),
    MEM9_SOURCE_PAGE_SIZE: z.coerce
      .number()
      .int()
      .positive()
      .max(200)
      .default(200),
    MEM9_SOURCE_REQUEST_TIMEOUT_MS: z.coerce
      .number()
      .int()
      .positive()
      .default(10000),
    MEM9_SOURCE_FETCH_RETRIES: z.coerce.number().int().min(0).max(5).default(2),
    MEM9_SOURCE_FETCH_RETRY_BASE_MS: z.coerce
      .number()
      .int()
      .positive()
      .default(250),
    MEM9_SOURCE_DELETE_CONCURRENCY: z.coerce
      .number()
      .int()
      .positive()
      .max(20)
    ...
    DEEP_ANALYSIS_CHUNK_CONCURRENCY: z.coerce
      .number()
      .int()
      .positive()
      .default(5),
    ...
    SQS_VISIBILITY_TIMEOUT_SECONDS: z.coerce
      ...
      .positive()
      .default(30),
    SQS_VISIBILITY_HEARTBEAT_SECONDS: z.coerce
      .number()
      .int()
      .positive()
      .default(10),
  ...
  return {
    ...
    analysis: {
      ...
      deepAnalysisDailyLimitBypassFingerprints:
        env.DEEP_ANALYSIS_DAILY_LIMIT_BYPASS_FINGERPRINTS?.split(',')
